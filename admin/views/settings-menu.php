	...
	<form method="post" action="edit.php?post_type=incsub_event&page=eab_settings">
		...
		<div class="eab-metaboxcol metabox-holder eab-metaboxcol-one eab-metaboxcol-center">
			...
			<div id="eab-settings-general" class="eab-metabox postbox">
				...
				<div class="eab-inside">
					<div class="eab-settings-settings_item">
						<label for="incsub_event-slug" id="incsub_event_label-slug"><?php _e('Stelle hier Root-Slug ein:', eab_domain() ); ?></label>
					...
					<div class="eab-settings-settings_item">
						<label for="incsub_event-ordering_direction" id="incsub_event_label-ordering_direction"><?php _e('Stelle absteigende Reihenfolge nach Startdatum ein:', eab_domain() ); ?></label>
						<?php
					...
					<div class="eab-settings-settings_item">
						<label for="incsub_event-pagination" id="incsub_event_label-pagination"><?php _e('Paginierung einstellen (Ereignisse):', eab_domain() ); ?></label>
					...
					<div class="eab-settings-settings_item">
						<label for="incsub_event-accept_payments" id="incsub_event_label-accept_payments"><?php _e('Akzeptierst Du Zahlung für eine Deiner Veranstaltungen?', eab_domain() ); ?></label>
					...
					<div class="eab-settings-settings_item">
						<label for="incsub_event-accept_api_logins" id="incsub_event_label-accept_api_logins"><?php _e('Erlaube Facebook und Twitter Login?', eab_domain() ); ?></label>
					...
					<div class="eab-settings-settings_item">
						<label for="incsub_event-display_attendees" id="incsub_event_label-display_attendees"><?php _e('Öffentliche RSVPs anzeigen?', eab_domain() ); ?></label>
			...
			<?php if (!$theme_tpls_present) { ?>
				<div id="eab-settings-appearance" class="eab-metabox postbox">
					...
					<div class="eab-inside">
						<div class="eab-settings-settings_item">
							<label for="incsub_event-override_appearance_defaults" id="incsub_event_label-override_appearance_defaults"><?php _e('Standarddarstellung überschreiben?', eab_domain() ); ?></label>
						...
						<div class="eab-settings-settings_item">
							<?php if (!$archive_tpl_present) { ?>
								<label for="incsub_event-archive_template" id="incsub_event_label-archive_template"><?php _e('Archivvorlage', eab_domain() ); ?></label>
						...
						<div class="eab-settings-settings_item">
							<?php if (!$single_tpl_present) { ?>
								<label for="incsub_event-single_template" id="incsub_event_label-single_template"><?php _e('Einzelereignisvorlage', eab_domain() ); ?></label>
			...
			<div id="eab-settings-paypal" class="eab-metabox postbox">
				...
				<div class="eab-inside">
					<div class="eab-settings-settings_item">
						<label for="incsub_event-currency" id="incsub_event_label-currency"><?php _e('Währung', eab_domain() ); ?></label>
					...
					<div class="eab-settings-settings_item">
						<label for="incsub_event-paypal_email" id="incsub_event_label-paypal_email"><?php _e('PayPal E-Mail Addresse', eab_domain() ); ?></label>
					...
					<div class="eab-settings-settings_item">
						<label for="incsub_event-paypal_sandbox" id="incsub_event_label-paypal_sandbox"><?php _e('PayPal Sandbox Modus?', eab_domain() ); ?></label>
		...
		<p class="submit clear">
			...
			<?php if (isset($_REQUEST['eab_step']) && $_REQUEST['eab_step'] == 1) { ?>
				<a href="edit.php?post_type=incsub_event&page=eab_welcome&eab_step=-1" class="button"><?php _e('Gehe zurück zu Erste Schritte', eab_domain() ) ?></a>
			<?php } ?>
		</p>
	</form>
</div>
