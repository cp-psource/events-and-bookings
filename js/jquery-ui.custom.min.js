...
(function(d, C) {
    ...
    d.extend(M.prototype, {
        ...
        _attachDatepicker: function(a, b) {
            var c = null;
            for (var e in this._defaults) { var f = a.getAttribute("date:" + e); if (f) { c = c || {}; try { c[e] = eval(f) } catch (h) { c[e] = f } } }
        ...
        _connectDatepicker: function(a, b) {
            ...
            if (!c.hasClass(this.markerClassName)) {
                ...
                c.addClass(this.markerClassName).keydown(this._doKeyDown).on("keypress", this._doKeyPress).on("keyup", this._doKeyUp).on("setData.datepicker",
        ...
        _inlineDatepicker: function(a,
            ...
            var c = d(a);
            if (!c.hasClass(this.markerClassName)) {
                c.addClass(this.markerClassName).append(b.dpDiv).on("setData.datepicker", function(e, f, h) { b.settings[f] = h }).on("getData.datepicker", function(e, f) { return this._get(b, f) });
                d.data(a, "datepicker", b);
        ...
        _destroyDatepicker: function(a) {
            ...
            if (b.hasClass(this.markerClassName)) {
                ...
                if (e == "input") {
                    c.append.remove();
                    c.trigger.remove();
                    b.removeClass(this.markerClassName).off("focus", this._showDatepicker).off("keydown", this._doKeyDown).off("keypress", this._doKeyPress).off("keyup", this._doKeyUp)
        ...
        _updateDatepicker: function(a) {
            ...
            a.dpDiv.find("." + this._dayOverClass + " a").on("mouseover", ;
    ...
    d.fn.datepicker = function(a) {
        ...
        if (!d.datepicker.initialized) {
            d(document).on("mousedown", d.datepicker._checkExternalClick).find("body").append(d.datepicker.dpDiv);
