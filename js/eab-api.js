...
(function($) {
    ...
    function get_google_login_button() {
        if (!l10nEabApi.data.gg_client_id) return '<li><a href="#" class="psourceevents-login_link psourceevents-login_link-google">' + l10nEabApi.google + '</a></li>';
    ...
    function create_login_interface($me) {
        if ($("#psourceevents-login_links-wrapper").length) {
            $("#psourceevents-login_links-wrapper").remove();
        }
        $me.parents('.psourceevents-buttons').after('<div id="psourceevents-login_links-wrapper" />');
        var $root = $("#psourceevents-login_links-wrapper");
        var post_id = $me.parents(".psourceevents-buttons").find('input:hidden[name="event_id"]').val();
        $root.html(
            '<ul class="psourceevents-login_links">' +
            (l10nEabApi.data.show_facebook ? '<li><a href="#" class="psourceevents-login_link psourceevents-login_link-facebook">' + l10nEabApi.facebook + '</a></li>' : '') +
            (l10nEabApi.data.show_twitter ? '<li><a href="#" class="psourceevents-login_link psourceevents-login_link-twitter">' + l10nEabApi.twitter + '</a></li>' : '') +
            (l10nEabApi.data.show_google ? get_google_login_button() : '') +
            (l10nEabApi.data.show_wordpress ? '<li><a href="#" class="psourceevents-login_link psourceevents-login_link-wordpress">' + l10nEabApi.wordpress + '</a></li>' : '') +
            '<li><a href="#" class="psourceevents-login_link psourceevents-login_link-cancel">' + l10nEabApi.cancel + '</a></li>' +
            '</ul>'
        );
        $me.addClass("active");
        $root.find(".psourceevents-login_link").each(function() {
            var $lnk = $(this);
            var callback = false;
            if ($lnk.is(".psourceevents-login_link-facebook")) {
                // Facebook login
                callback = function() {
            ...
            } else if ($lnk.is(".psourceevents-login_link-twitter")) {
                callback = function() {
            ...
            } else if ($lnk.is(".psourceevents-login_link-google")) {
                callback = function() {
            ...
            } else if ($lnk.is(".psourceevents-login_link-wordpress")) {
            ...
            } else if ($lnk.is(".psourceevents-login_link-cancel")) {
                // Drop entire thing
                callback = function() {
