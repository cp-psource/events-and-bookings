    ...
    $.extend(Timepicker.prototype, {
        ...
        _rebindDialogEvents: function(inst) {
            ...
            inst.tpDiv
                ...
                .off()
                .on("click", { fromDoubleClick: false }, $.proxy($.timepicker.selectMinutes, this))
                .on("dblclick", { fromDoubleClick: true }, $.proxy($.timepicker.selectMinutes, this))
                .end()
                .find('.ui-timepicker-hour-cell')
                .off()
                .on("click", { fromDoubleClick: false }, $.proxy($.timepicker.selectHours, this))
                .on("dblclick", { fromDoubleClick: true }, $.proxy($.timepicker.selectHours, this))
                .end()
