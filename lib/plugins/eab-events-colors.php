...
<div id="eab-settings-colors" class="eab-metabox postbox">
	<h3 class="eab-hndle"><?php _e('Ereignisfarben', Eab_EventsHub::TEXT_DOMAIN); ?></h3>
	<div class="eab-inside">
	<?php foreach ($categories as $category) { ?>
		<div class="eab-settings-settings_item">
		<?php
			if ( is_object( $category )  ) {
				$label = sprintf(__('Ereigniskategorie: &quot;%s&quot;', Eab_EventsHub::TEXT_DOMAIN), esc_html($category->name));
				...
				$label = __('Standard', Eab_EventsHub::TEXT_DOMAIN);
				$cat = '__default__';
		...
		?>
			...
			<label for="<?php echo $for; ?>-bg">
				<span class="eab-color-text"><?php _e('Hintergrund', Eab_EventsHub::TEXT_DOMAIN); ?></span><br/>
			...
			<label for="<?php echo $for; ?>-skip">
				...
				<?php _e('Überspringen', Eab_EventsHub::TEXT_DOMAIN); ?>
			</label>
		</div>
	<?php } ?>
		<div class="eab-settings-settings_item">
			<button id="eab-colors-reset_to_defaults" class="button"><?php _e('Auf Standardeinstellung zurücksetzen', Eab_EventsHub::TEXT_DOMAIN); ?></button>
		</div>
		<div class="eab-settings-settings_item">
			...
			<label for="eab-colors-use_widget"><?php esc_html_e(__('Wende Hintergründe auf ein Kalender-Widget mit einer Kategorie an', Eab_EventsHub::TEXT_DOMAIN)); ?></label>
			<span><?php echo $tips->add_tip(__('Wenn Du diese Option auswählst, werden die Vordergrund- und Hintergrundfarbe auf Deine Kalender-Widget-Ereignisse übertragen, sofern nur eine Kategorie für die Anzeige ausgewählt ist.', Eab_EventsHub::TEXT_DOMAIN)); ?></span>
		</div>
		<div class="eab-settings-settings_item">
			...
			<label for="eab-colors-use_expanded_widget"><?php esc_html_e(__('Wende Farben auf erweiterte Ereignisse des Kalender-Widgets an', Eab_EventsHub::TEXT_DOMAIN)); ?></label>
		</div>
	</div>
</div>
<script>
