	...
	function show_nags () {
		if (!class_exists('AgmMapModel')) {
			echo '<div class="error"><p>' .
				sprintf(__("Du benötigst das <a href='%s'>PS-Gmaps</a> Plugin installiert and aktiviert um diese Erweiterung aktivieren zu können", Eab_EventsHub::TEXT_DOMAIN), 'https://n3rds.work/piestingtal-source-project/ps-gmaps/') .
			'</p></div>';
		}
	}
...
<div id="eab-settings-event_maps_options" class="eab-metabox postbox">
	<h3 class="eab-hndle"><?php _e('Optionen für Ereigniskarten', Eab_EventsHub::TEXT_DOMAIN); ?></h3>
	<div class="eab-inside">
		<p><em><?php _e('Alle Einstellungen, die Du hier leer lässt, werden von den Standardeinstellungen des Google Maps-Plugins übernommen.', Eab_EventsHub::TEXT_DOMAIN); ?></em></p>
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e('Map Größe', Eab_EventsHub::TEXT_DOMAIN)?></th>
				<td>
					<label for="eab-google_maps-width">
						<?php _e('Breite:', Eab_EventsHub::TEXT_DOMAIN); ?>
					...
					<label for="eab-google_maps-height">
						<?php _e('Höhe:', Eab_EventsHub::TEXT_DOMAIN); ?>
			...
			<tr valign="top">
				<th scope="row"><?php _e('Kartenaussehen', Eab_EventsHub::TEXT_DOMAIN)?></th>
				<td>
					<style>
					...
					<table celpadding="5" cellspacing="5" class="eab_inner_table">
						<tr>
							...
							<td valign="top">
								...
								<em class="eab-inline_help"><?php _e('Zahlenwert', Eab_EventsHub::TEXT_DOMAIN); ?></em>
							</td>
						</tr>
						<tr>
							<td valign="top">
								<label for="eab-google_maps-type">
									<?php _e('Typ:', Eab_EventsHub::TEXT_DOMAIN); ?>
								</label>
							</td>
							<td valign="top">
						...
						<tr>
							<td valign="top"><label for="eab-google_maps-units"><?php _e('Einheiten:', Eab_EventsHub::TEXT_DOMAIN); ?></label></td>
							<td valign="top">
						...
						<input type="checkbox" id="eab-google_maps-show_images" name="google_maps[overrides][show_images]" value="1" <?php checked(1, @$options['show_images']); ?> />
							...
							<td valign="top"><label for="eab-google_maps-show_images"><?php _e('Bilder anzeigen', Eab_EventsHub::TEXT_DOMAIN); ?></label></td>
						</tr>
					</table>
				</td>
			</tr>
