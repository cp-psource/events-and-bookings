...
class Eab_Shortcodes extends Eab_Codec {
	...
	function add_events_map_shortcode_help ($help) {
		$help[] = array(
			...
			'arguments' => array(
				...
				'lookahead' => array('help' => __('Verwende keine monatliche Standardseite - verwende stattdessen die Anzahl der Wochen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'weeks' => array('help' => __('Schaue so viele Wochen nach vorne', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'integer'),
				'category' => array('help' => __('Ereignisse aus dieser Kategorie anzeigen (ID oder Slug)', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:or_integer'),
				'categories' => array('help' => __('Ereignisse aus diesen Kategorien anzeigen - Akzeptiert eine durch Kommas getrennte Liste von IDs', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:id_list'),
				'limit' => array('help' => __('Zeige höchstens so viele Veranstaltungen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'integer'),
				'order' => array('help' => __('Sortiere Ereignisse in diese Richtung', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:sort'),
				'allow_multiple_markers' => array('help' => __('Anzeigen von Karten mit mehreren Markierungen zulassen - standardmäßig true.', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'open_only' => array('help' => __('Nur offene Ereignisse anzeigen - standardmäßig true.', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'show_date' => array('help' => __('Ereignisdatum in der Markierung anzeigen - standardmäßig true.', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'show_excerpt' => array('help' => __('Ereignis Auszug auf dem Marker  anzeigen.', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'featured_image' => array('help' => __('Verwende ein Ereignisbild anstelle von Kartenmarkierungen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'template' => array('help' => __('Subtemplate-Datei oder Vorlagenklassenaufruf', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string'),
				'...' => array('help' => __('und Google Maps Shortcode-Attribute', Eab_EventsHub::TEXT_DOMAIN)),
			),
	...
	function add_calendar_shortcode_help ($help) {
		$help[] = array(
			'title' 	=> __('Kalender-Shortcode', Eab_EventsHub::TEXT_DOMAIN),
			'tag' 		=> 'eab_calendar',
			'arguments' => array(
				'network' 			=> array('help' => __('Abfragetyp (Erfordert <a href="https://n3rds.work/piestingtal_source/multisite-beitragsindex-plugin/" target="_blank">Multisite Beitragsindex</a> Plugin', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'date' 				=> array('help' => __('Startdatum - Standard jetzt', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:date'),
				'relative_date' 	=> array('help' => __('Ein Datum relativ zum Jetzt oder zum Datum Argument', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:date_strtotime'),
				'category' 			=> array('help' => __('Ereignisse aus dieser Kategorie anzeigen (ID oder Slug)', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:or_integer'),
				'categories' 		=> array('help' => __('Ereignisse aus diesen Kategorien anzeigen - Akzeptiert eine durch Kommas getrennte Liste von IDs', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:id_list'),
				'navigation' 		=> array('help' => __('Navigation anzeigen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'track' 			=> array('help' => __('Behalte beim Navigieren die Bildlaufposition bei', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'title_format' 		=> array('help' => __('Das im Navigationstitel verwendete Datumsformat ist standardmäßig "M Y"', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:date_format'),
				'short_title_format'=> array('help' => __('Das Datumsformat für die kürzere Datumsdarstellung im Navigationstitel ist standardmäßig "m-Y"', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:date_format'),
				'long_date_format' 	=> array('help' => __('Das Datumsformat für die Anzeige der Darstellung langer Datumsangaben verwendet standardmäßig Deine Datumseinstellungen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:date_format'),
				'footer' 			=> array('help' => __('Kalendertabellenfußzeile anzeigen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'class' 			=> array('help' => __('Wende diese CSS-Klasse an', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string'),
				'with_thumbnail' 	=> array('help' => __('Miniaturansicht des Ereignisses anzeigen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'default_thumbnail' => array('help' => __('Verwende diese Bild-URL als Miniaturansicht, wenn für das Ereignis kein geeigneter Bildsatz vorhanden ist', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:url'),
				'show_excerpt' 		=> array('help' => __('Ereignisauszug in der Schnellübersicht anzeigen.', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'excerpt_length' 	=> array('help' => __('Bestimme die Länge des Auszugs (Anzahl der Zeichen), die angezeigt werden sollen.', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'integer'),
				'template' 			=> array('help' => __('Subtemplate-Datei oder Vorlagenklassenaufruf', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string'),
				'override_styles' 	=> array('help' => __('Schalte die Verwendung der Standardstile um', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'override_scripts' 	=> array('help' => __('Schalte die Verwendung von Standardskripten um', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'show_old'			=> array('help' => __('Vergangene Ereignisse im Kalender anzeigen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
			),
	...
	function add_archive_shortcode_help ($help) {
		$help[] = array(
			...
			'arguments' => array(
				...
				'limit' => array('help' => __('Zeige höchstens so viele Veranstaltungen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'integer'),
				'order' => array('help' => __('Sortiere Ereignisse in diese Richtung', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:sort'),
				'paged' => array('help' => __('Paging zulassen - Verwendung mit dem Argument "limit"', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'page' => array('help' => __('Beginne auf dieser Seite', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'integer'),
				'class' => array('help' => __('Wende diese CSS-Klasse an', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string'),
				'template' => array('help' => __('Subtemplate-Datei oder Vorlagenklassenaufruf', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string'),
				'with_thumbnail' => array('help' => __('Miniaturansicht des Ereignisses anzeigen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'thumbnail_size' => array('help' => __('Stelle die Größe der Miniaturansichten ein (\'thumbnail\', \'large\', \'medium-large\', \'medium\', \'full\' oder \'150,150\'', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string'),
				'override_styles' => array('help' => __('Schalte die Verwendung der Standardstile um', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'override_scripts' => array('help' => __('Schalte die Verwendung von Standardskripten um', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'end_date' => array('help' => __('Ende (YYYY-MM-DD)', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:date'),
				'day_only' => array('help' => __('Schalte die Anzeige nur der Ereignisse der aktuellen Tage um', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
			),
	...
	function add_expired_shortcode_help ($help) {
		$help[] = array(
			'title' => __('Shortcode für abgelaufene Ereignisse', Eab_EventsHub::TEXT_DOMAIN),
			'tag' => 'eab_expired',
			'arguments' => array(
				'class' => array('help' => __('Wende diese CSS-Klasse an', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string'),
				'category' => array('help' => __('Ereignisse aus dieser Kategorie anzeigen (ID oder Slug)', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string:or_integer'),
	...
	function add_single_shortcode_help ($help) {
		$help[] = array(
			'title' => __('Einzelereignis-Shortcode', Eab_EventsHub::TEXT_DOMAIN),
			'tag' => 'eab_single',
			'arguments' => array(
				'id' => array('help' => __('Ereignis-ID, die angezeigt werden soll', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'integer'),
				'slug' => array('help' => __('Event von diesem Slug anzeigen', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string'),
				'class' => array('help' => __('Wende diese CSS-Klasse an', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string'),
				'template' => array('help' => __('Subtemplate-Datei oder Vorlagenklassenaufruf', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'string'),
				'override_styles' => array('help' => __('Schalte die Verwendung der Standardstile um', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
				'override_scripts' => array('help' => __('Schalteie die Verwendung von Standardskripten um', Eab_EventsHub::TEXT_DOMAIN), 'type' => 'boolean'),
			),
			'advanced_arguments' => array('template', 'override_scripts', 'override_styles'),
		);
		return $help;
