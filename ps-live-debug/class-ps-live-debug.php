 ...
 * Description:       Aktiviert das Debuggen und fügt dem WordPress-Admin einen Bildschirm hinzu, um das debug.log anzuzeigen.
 * Version:           1.0.0
...
/*
Credits & Licences:
Dies ist ein persönliches Projekt, das ich zum Debuggen verwende, aber einige Teile des Codes wurden von anderen großartigen Leuten geschrieben.
...
if ( ! class_exists( 'PS_Live_Debug' ) ) {
	class PS_Live_Debug {
		 ...
		 * @uses esc_html_e()
		 * @uses _e()
		 * @uses PS_Live_Debug_WordPress_Info::create_page()
			...
			<div class="sui-wrap">
				...
				<div class="sui-row-with-sidenav">
					<div class="sui-sidenav">
						<ul class="sui-vertical-tabs sui-sidenav-hide-md">
							...
							<li class="sui-vertical-tab <?php echo ( ! empty( $subpage ) && 'WordPress' === $subpage ) ? 'current' : ''; ?>">
								<a href="?page=ps-live-debug&subpage=WordPress"><?php esc_html_e( 'WordPress', 'ps-live-debug' ); ?></a>
							</li>
						...
						<div class="sui-sidenav-hide-lg">
							<select class="sui-mobile-nav" style="display: none;" onchange="location = this.value;">
								...
								<option value="?page=ps-live-debug&subpage=WordPress" <?php echo ( ! empty( $subpage ) && 'WordPress' === $subpage ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'WordPress', 'ps-live-debug' ); ?></option>
					...
					if ( ! empty( $subpage ) ) {
						switch ( $subpage ) {
							case 'WordPress':
								PS_Live_Debug_WordPress_Info::create_page();
								break;
							case 'Server':
	...
	new PS_Live_Debug_WordPress_Info();
