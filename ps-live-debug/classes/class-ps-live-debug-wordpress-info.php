...
/**
 * PS_Live_Debug_WordPress_Info Class.
 */
if ( ! class_exists( 'PS_Live_Debug_WordPress_Info' ) ) {
	class PS_Live_Debug_WordPress_Info {

		/**
		 * PS_Live_Debug_WordPress_Info constructor.
		 *
		 * @uses PS_Live_Debug_WordPress_Info::init()
		 *
		 * @return void
		 */
		...
		public static function init() {
			add_action( 'wp_ajax_ps-live-debug-wordpress-info-general-information', array( 'PS_Live_Debug_WordPress_Info', 'general_information' ) );
			add_action( 'wp_ajax_ps-live-debug-wordpress-info-directory-permissions', array( 'PS_Live_Debug_WordPress_Info', 'directory_permissions' ) );
			add_action( 'wp_ajax_ps-live-debug-wordpress-info-installation-size', array( 'PS_Live_Debug_WordPress_Info', 'installation_size' ) );
			add_action( 'wp_ajax_ps-live-debug-wordpress-info-constants', array( 'PS_Live_Debug_WordPress_Info', 'constants' ) );
		}
		...
		public static function general_information() {
			...
			$wp = array(
				array(
					'label' => esc_html__( 'WordPress Version', 'ps-live-debug' ),
					'value' => $wp_version,
				),
				array(
				...
				array(
					'label' => esc_html__( 'Verbindung mit WordPress.org', 'ps-live-debug' ),
					'value' => $dotorg,
				),
				array(
		...
		public static function installation_size() {
			...
			$directories = array(
				...
				array(
					'label' => esc_html__( 'WordPress-Verzeichnis', 'ps-live-debug' ),
