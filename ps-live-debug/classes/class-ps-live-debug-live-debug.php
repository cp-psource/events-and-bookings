				...
				<div class="sui-box">
					...
					<div class="sui-box-footer">
						<p class="sui-description">
							...
							<br><br>
							<?php _e( "<strong>WP Debug: <code>define( 'WP_DEBUG', true ); define( 'WP_DEBUG_LOG', true ); define( 'WP_DEBUG_DISPLAY', false ); @ini_set( 'display_errors', 0 );</code>", 'ps-live-debug' ); ?>
							<br>
							...
							<br><br>
							<?php esc_html_e( 'You can always find more information at', 'ps-live-debug' ); ?> <a target="_blank" rel="noopener" href="https://codex.wordpress.org/Debugging_in_WordPress"><?php esc_html_e( 'Debugging in WordPress', 'ps-live-debug' ); ?></a>.
						</p>
					</div>
				</div>
			<?php
			...
			if ( file_exists( $log_file ) ) {
				if ( 2000000 > filesize( $log_file ) ) {
					...
					if ( empty( $debug_contents ) ) {
						...
						$debug_contents = sprintf( esc_html__( 'Awesome! %1$s seems to be empty.', 'ps-live-debug' ), basename( $log_file ) );
					}
				} else {
					// translators: %1$s log filename.
