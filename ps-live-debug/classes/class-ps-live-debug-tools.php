		...
		*/
		public static function create_checksums_response( $files ) {
			...
			if ( empty( $files ) ) {
				...
				$output .= '<br>' . esc_html__( "Dies kann ein falsch positives Ergebnis sein, wenn Ihre Installation übersetzte Versionen enthält. Eine einfache Möglichkeit, dies zu beheben, besteht darin, WordPress neu zu installieren, aber keine Sorge, da dies nur die WordPress-Kerndateien betrifft.", 'ps-live-debug' );
