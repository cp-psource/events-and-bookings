...
(function($) {
    ...
    function create_interface(e) {
        ...
        var $me = $(this),
            text = $me.text();
        $me.parents('.psourceevents-buttons').append('<div id="eab-rsvps-rsvp_with_email-wrapper" />');
        var $root = $("#eab-rsvps-rsvp_with_email-wrapper"),
            post_id = $me.parents(".psourceevents-buttons").find('input:hidden[name="event_id"]').val();
